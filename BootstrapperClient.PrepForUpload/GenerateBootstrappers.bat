...
call:generateFlavorFunc Gametest setup-gametest.pekora.zip gametest.pekora.zip %1
...
call:generateFlavorFunc Sitetest setup-sitetest.pekora.zip sitetest.pekora.zip %1
...
Resources\rtc.exe /plhd01="%~2" /plhd02="%~3" /plhd03="..\UploadBits\Win32-%~4%~1-BootstrapperClient\PekoraPlayerLauncher.exe" /plhd04="..\UploadBits\Win32-%~4%~1-BootstrapperClient\PekoraPlayerLauncher.exe" /F:"Resources\updateBootstrapperRC.rts"
...
Resources\rtc.exe /plhd01="%~2" /plhd02="%~3" /plhd03="..\UploadBits\Win32-%~4%~1-BootstrapperRccService\Pekora.exe" /plhd04="..\UploadBits\Win32-%~4%~1-BootstrapperRccService\Pekora.exe" /F:"Resources\updateBootstrapperRC.rts"
