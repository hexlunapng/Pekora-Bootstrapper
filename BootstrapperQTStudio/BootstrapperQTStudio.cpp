...
static const TCHAR* BootstrapperMutexName           = _T("www.pekora.zip/bootstrapperQTStudio");
static const TCHAR* StartRobloxStudioAppMutex       = _T("www.pekora.zip/startRobloxQTStudioApp");
static const TCHAR* FriendlyName                    = _T("Pekora Studio");
static const TCHAR* StartEvent                      = _T("www.pekora.zip/robloxQTStudioStartedEvent");
